...
def show_authenticated_app():
    ...
    if page == "🚕 Fare Calculator":
        ...
        # Short about text (detailed project report removed as requested)
        st.markdown("""
        ## 🚕 Cab Fare Estimator

        The detailed project report has been removed from this About page per your request.
        Use the Fare Calculator, Trip Analytics, and Data Export sections to interact with the system.
        """)
